...
class _ProfilePageState extends State<ProfilePage> {
  ...
  getProfile() async {
    ...
    try {
      final Response res = await userService.getUser(userid!);
      if (mounted) {
        setState(() {
          _data = res.data;
  ...
  updateEmail() async {
    ...
    String? userid = allValues["userid"];
    try {
      final Response res = await userService.updateEmail(_email.text, userid!);
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
  ...
  updatePhone() async {
    ...
    String? userid = allValues["userid"];
    try {
      final Response res = await userService.updatePhoneNumber(
  ...
  changePassword() async {
    ...
    try {
      final Response res =
          await userService.updatePassword(_newpassword.text, userid!);
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
